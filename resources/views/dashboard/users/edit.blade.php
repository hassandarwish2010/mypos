	                    ...
	                    <div class="col-md-12">
	                        <div class="card">
	                            <div class="card-body">
	                                ...
	                                <form class="form-horizontal" method="post" action="{{ route('dashbord.users.update',$user->id) }}" enctype="multipart/form-data">
	                                	{{ csrf_field() }}
	                                	{{ method_field('put') }}
	                                    ...
	                                    <div class="form-group">
	                                        ...
	                                        <div class="cols-sm-10">
	                                            <div class="input-group">
	                                                ...
	                                                <input type="text" class="form-control" name="first_name" value='{{ $user->first_name }}' id="name" placeholder="@lang('site.first_name')" />
	                                            </div>
	                                        </div>
	                                    </div>
	                                    <div class="form-group">
	                                        ...
	                                        <div class="cols-sm-10">
	                                            <div class="input-group">
	                                                ...
	                                                <input type="text" class="form-control" name="email" id="email" value='{{ $user->email }} ' placeholder="Enter your Email" />
	                                            </div>
	                                        </div>
	                                    </div>
	                                    <div class="form-group">
	                                        ...
	                                        <div class="cols-sm-10">
	                                            <div class="input-group">
	                                                ...
	                                                <input type="text" class="form-control" name="last_name" value="{{ $user->last_name }}" id="last_name" placeholder="@lang('site.last_name')" />
	                                            </div>
	                                        </div>
	                                    </div>
	                                    ...
	                                    <div class="form-group">
	                                        ...
	                                        <div class="cols-sm-10">
	                                            <div class="input-group">
	                                                <img src="{{$user->image_path}}" class="img-thumbnail image-preview" style="width: 70px;height: 50px">
	                                            </div>
	                                        </div>
